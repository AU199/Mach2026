...
public class PhaseTimer {
    ...
    public boolean IsItOurTurn(
        ...
        Alliance shift2and4Team = gameData.charAt(0) == 'R'
            ? Alliance.Red
            : Alliance.Blue;
        boolean areWeShift2and4Team = alliance.equals(shift2and4Team)
            ? true
            : false;
        if (matchTime > 130) {
            return true;
    ...
    public void gameDataSender() {
        ...
        if (alliance.isEmpty()) {
            ...
            SmartDashboard.putString(
                "Alliance",
                alliance.equals(Alliance.Red) ? "Red" : "Blue"
            );
        }
