...
public final class Constants {
  ...
  public static final String kAprilTagPath = Paths.get("").toAbsolutePath().toString()
  ...
  public static final Transform3d kRobotToCam = new Transform3d(0,0 ,0,new Rotation3d(0,Math.toRadians(-15),0));
