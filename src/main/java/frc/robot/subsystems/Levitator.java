...
public class Levitator extends SubsystemBase {
    ...
    public Command lift(){
        return startEnd(() -> {
            levitatorMotor.setControl(positionVoltage.withPosition(LEVITATOR_LIFT_POSITION));
    ...
    public Command retract(){
        return startEnd(() -> {
            levitatorMotor.setControl(positionVoltage.withPosition(LEVITATOR_RETRACT_POSITION));
    ...
    private boolean done_lifting(){
        return levitatorMotor.getPosition().getValueAsDouble() > LEVITATOR_LIFT_POSITION;
    }
    private boolean done_retracting(){
        return levitatorMotor.getPosition().getValueAsDouble() < LEVITATOR_RETRACT_POSITION;
    }
