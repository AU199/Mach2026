...
public class IntakeRollers extends SubsystemBase {
    ...
    private TalonFX rollerMotor = new TalonFX(
        Constants.rollerMotorId,
        "DriveBase"
    );
    private TalonFX rollerMotor2 = new TalonFX(
        Constants.rollerMotor2Id,
        "DriveBase"
    );
    ...
    public IntakeRollers() {
        rollerMotor2.setControl(
            new Follower(Constants.rollerMotorId, MotorAlignmentValue.Opposed)
        );
    }
